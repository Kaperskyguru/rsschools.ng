        ...
        <div id ="carousel-example-generic" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">
                    <img class="slide-image" src="res/imgs/1.jpg" style="width: 100%; height: 350px;" alt="">
                </div>
                <div class="item">
                    <img class="slide-image" src="res/imgs/8722.gif" style="width: 100%; height: 350px;" alt="">
                </div>
                <div class="carousel-caption">
                    <div class="text-center">
                        <h1 class="site-slogan" style="color:#FFF">Schooling in Rivers State just got easier</h1>
                        <h5 style="color:#FFF" class="site-slogan">Schooling in Rivers State just got easier</h5>
                    </div>
                    <div>
                        <div class="row">
